...
//    String genPath="E:\\前后端分离\\common-system\\code\\eladmin\\eladmin-system\\src\\test\\java\\me\\zhengjie\\";
   static String genPath = "E:\\study\\eladmin\\eladmin-system\\src\\test\\java\\me\\zhengjie\\";
...
//        生成文件路径
            File file = new File(genPath + genModule + suffix);
...
//        生成文件路径
    ...
    public static String getAdminFilePath(String templateName, String className) {
        String packagePath =genPath+File.separator + "src" +File.separator+ "main" + File.separator + "java" + File.separator;
