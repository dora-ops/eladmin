...
public class TopicController {
    ...
    @Log("查询全部Topic")
    @GetMapping(value = "/queryAll/topic")
    @PreAuthorize("hasAnyRole('ADMIN')")
    public ResponseEntity queryTopics(TopicDTO resources){
        return new ResponseEntity(topicQueryService.queryAll(resources),HttpStatus.OK);
    }

    @Log("查询Users")
    @GetMapping(value = "/findById/topic")
    @PreAuthorize("hasAnyRole('ADMIN')")
